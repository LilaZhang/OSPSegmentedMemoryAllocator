...
int main() {
    ...
    vector<double*>* nums = (vector<double*>*)SegmentedMemoryAllocator::alloc(sizeof(vector<double*>), FIRST_FIT);
    ...
    for(int i = 0; i < MEDIUM; ++i) {
        ...
        double* n = (double*)SegmentedMemoryAllocator::alloc(sizeof(double), FIRST_FIT);
